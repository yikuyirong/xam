...
namespace Hungsum.Framework.UI.Pages
{
    public class Panel_Login : Panel_ZD, IUcLoginPage
    {
        ...
        //    ToolbarItem item = items.FirstOrDefault(r => ((HsCommandParams)r.CommandParameter).ActionKey == MenuItemKeys.确定);
