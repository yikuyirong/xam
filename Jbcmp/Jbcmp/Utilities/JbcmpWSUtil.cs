...
{
    public class JbcmpWSUtil : SysWSUtil
    {
        #region 客户维护
        ...
        public async Task<List<HsLabelValue>> ShowXms(string progressId, string beginDate, string endDate, string xmjd, string xmzt)
        {
